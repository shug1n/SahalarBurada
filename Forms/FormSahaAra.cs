    ...
    public partial class FormSahaAra : BaseChildForm
    {
        ...
        private void SaatleriGuncelle()
        {
            ...
            foreach (var item in tumSaatler)
            {
                if (bugun)
                {
                    int slotBaslangic = item.baslangicSaat;
